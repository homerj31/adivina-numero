#PARA LA EJECUCIÓN DE ESTE CODIGO SE PRECISA DEL ARCHIVO "mejor_marca" Y EL MODULO "VALID.py" PRESENTES EN ESTE REPOSITORIO ("adivina-numero")
#EL JUGADOR TENDRÁ QUE ADIVINAR UN NÚMERO, ESCOGIDO AL AZAR POR LA COMPUTADORA.
